...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * page? AfterAll Uncaught TypeError: Cannot read property 'url' of undefined thrown
         */
         ...
         */
          ...
          */
          it('menu changes visibility', function() {
            $('a.menu-icon-link').trigger('click'); //showing menu
            expect($('body').hasClass('menu-hidden')).toBe(false); //not hiding menu
            $('a.menu-icon-link').trigger('click'); //hiding menu again
            expect($('body').hasClass('menu-hidden')).toBe(true); // hiding menu
          });
     });
